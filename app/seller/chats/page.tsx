    ...
    <DashboardLayout user={user}>
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">Communicate with customers and manage inquiries</p>
        </div>
        ...
        {isLoading ? (
          ...
          <Card>
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600">When customers message you, their conversations will appear here.</p>
            </CardContent>
          </Card>
        ) : (
