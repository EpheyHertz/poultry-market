    ...
    <DashboardLayout user={user}>
      <div className="space-y-8">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Vouchers & Discounts</h1>
            <p className="text-gray-600 mt-2">Create and manage discount vouchers for your products</p>
          </div>
          <Dialog open={showForm} onOpenChange={setShowForm}>
            ...
            <DialogContent className="max-w-2xl">
              <DialogHeader>
                ...
                <DialogDescription>
                  Create a discount voucher for your customers
                </DialogDescription>
              </DialogHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage your discount vouchers and track their usage</CardDescription>
          </CardHeader>
          <CardContent>
            {vouchers.length === 0 ? (
