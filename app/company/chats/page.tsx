...
import { MessageCircle, Package, ShoppingCart, User, Clock } from 'lucide-react';
    ...
    <DashboardLayout user={user}>
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">Communicate with customers, sellers, and manage business inquiries</p>
        </div>
        ...
        {isLoading ? (
          ...
          <Card>
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600">When customers or sellers message you, their conversations will appear here.</p>
            </CardContent>
          </Card>
        ) : (
